        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('events.attendance-slots.update', ['event' => $event, 'attendance_slot' => $slot]) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $slot->title) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="date" id="date" value="{{ old('date', $slot->date) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300"
                                required>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                            <div>
                                ...
                                <x-text-input id="start_time" type="time" name="start_time" :value="old('start_time', $slot->start_time)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="end_time" type="time" name="end_time" :value="old('end_time', $slot->end_time)" required />
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <div>
                                ...
                                <x-text-input id="absent_time" type="time" name="absent_time" :value="old('absent_time', $slot->absent_time)" required />
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <div class="mt-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            <h4 class="font-medium text-gray-900 dark:text-gray-100 mb-2">Time Windows:</h4>
                            <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                                <li>• <span class="text-green-600 dark:text-green-400">Present:</span> Between Start Time and End Time</li>
                                <li>• <span class="text-yellow-600 dark:text-yellow-400">Late:</span> Between End Time and Cutoff Time</li>
                                <li>• <span class="text-red-600 dark:text-red-400">Absent:</span> After Cutoff Time</li>
                            </ul>
                        </div>
