<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="idno" name="idno" type="text" class="mt-1 block w-full" :value="old('idno', $user->idno)" required />
        ...
        <div>
            ...
            <x-select id="department" name="department" class="mt-1 block w-full" required>
                <option value="{{ old('department', $user->department) }}" selected>{{ old('department', $user->department) }}</option>
        ...
        <div>
            ...
            <x-select id="year" name="year" class="mt-1 block w-full" required>
